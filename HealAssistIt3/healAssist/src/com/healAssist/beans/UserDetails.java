...
public class UserDetails {
	...
	public String toString() {
		return "UserDetails [userId="+ userId +", fullName=" + fullName + ", userEmail=" + userEmail + ", userPhone=" + userPhone
				+ ", gender=" + gender + ", age=" + age + ", address=" + address + ", city=" + city + ", country="
				+ country + ", userName=" + userName + ", password=" + password + ", userType=" + userType + ", cases="
				+ cases + "]";
	}
